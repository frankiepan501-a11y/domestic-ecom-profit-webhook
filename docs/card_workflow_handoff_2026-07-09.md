...
- 2026-07-10 财务确认卡按钮说明补充：四个按钮上方必须直接写明点击后的业务后果。确认该平台定稿=财务认可本平台本月毛利报表，记录确认人/时间，四个平台都确认后归档；退回资料缺失=原始结算/广告/物流/成本资料不完整，退回运营补资料后重算；退回金额/口径异常=资料齐但金额、费用归类、退款/结算口径或负毛利原因需解释/重算；接受本期临时估算=财务同意本期按临时估算或暂缓口径先定稿，并保留例外说明。
